...
/**
 * @file    SPC57EMxx/hal_lld.h
 * @brief   SPC57EMxx HAL subsystem low level driver header.
 ...
 * @{
 */
#define PLATFORM_NAME                       "SPC57EMxx High End Powertrain"
/** @} */
...
#if !defined(SPC57EMxx_MCUCONF)
#error "Using a wrong mcuconf.h file, SPC57EMxx_MCUCONF not defined"
#endif
